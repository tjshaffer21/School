...
BasicObject* Picture::readObject(char* fileName)
{
   ...
   while (!file->eof())
   {
      ...
      else if (*token == *f)  //face definition
      {
         ...
         delete str2;
         delete str3;
      } else if ( *token == *vt ) { // need to skip a line.
          delete token;
          ...
          double s1 = atof( str1->c_str() );
          double t1 = atof( str2->c_str() );
          double s2 = atof( str3->c_str() );
          double t2 = atof( str4->c_str() );
          double s3 = atof( str5->c_str() );
          double t3 = atof( str6->c_str() );
